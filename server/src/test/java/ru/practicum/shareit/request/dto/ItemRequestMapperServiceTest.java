...
class ItemRequestMapperServiceTest {
    ...
    @Test
    void testPrepareForSaveItemRequest_whenIncomeCorrect_thenReturnEntity() {
    ...
    @Test
    void testPrepareForSaveItemRequest_whenUserNotFound_thenThrowsException() {
    ...
    @Test
    void testPrepareForSaveItemRequest_whenUserIncorrect_thenThrowsException() {
        when(userService.getUser(-999L)).thenThrow(UserNotFoundException.class);
        UserNotFoundException userNotFoundException = assertThrows(UserNotFoundException.class,
                () -> itemRequestMapperService.prepareForSaveItemRequest(-999L, dtoToPrepareItemRequest));
        userNotFoundException.getMessage();
    ...
    @Test
    void testRequesterValidate_whenUserIdCorrect_thenReturnTrue() {
        when(userService.getUser(1L)).thenReturn(userDtoRequester);
        assertTrue(itemRequestMapperService.requesterValidate(1L));
    }

    @Test
    void testRequesterValidate_whenUserIdNotValid_thenReturnFalse() {
    ...
    @Test
    void testRrepareForReturnDto_whenIncomeRequestIsCorrect_thenReturnDto() {
    ...
    @Test
    void testPrepareForReturnDto_whenItemNotFound_thenReturnDtoWithEmptyList() {
        ItemRequest itemRequest = ItemRequest.builder()
                .id(1L)
                .description("some item")
                .requester(requester)
    ...
    @Test
    void testPrepareForReturnListDto() {
