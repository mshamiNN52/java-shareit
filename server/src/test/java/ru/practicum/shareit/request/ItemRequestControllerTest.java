...
class ItemRequestControllerTest {
    ...
    @Test
    void testAddRequest_whenRequestIsCorrect_thenReturn200AndFields() throws Exception {
    ...
    @Test
    void testGetItemRequests_whenUserHasRequest_thenReturn200() throws Exception {
    ...
    @Test
    void testGetItemRequests_whenUserNotFound_thenReturn404() throws Exception {
    ...
    @Test
    void testGetItemRequests_whenUserHasNotRequests_thenReturn404() throws Exception {
    ...
    @Test
    void testGetItemRequests_whenUserWithIncorrectId_thenReturn404() throws Exception {
    ...
    @Test
    void testGetItemRequest_whenUserAndRequestAreCorrect_thenReturn200() throws Exception {
    ...
    @Test
    void testGetAllItemRequests_whenCorrect_thenReturn200() throws Exception {
