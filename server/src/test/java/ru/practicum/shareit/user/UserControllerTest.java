...
class UserControllerTest {
    ...
    @SneakyThrows
    @Test
    void testCreate_whenIncomingDtoCorrect_thenReturnStatusIsOkWithBody() {
    ...
    @SneakyThrows
    @Test
    void testCreate_whenNewUserDtoWithoutEmailAndName_thenStatus400AndThrowException() {
    ...
    @SneakyThrows
    @Test
    void testFindAll_whenListUsersIsEmpty_thenReturnEmptyList() {
    ...
    @SneakyThrows
    @Test
    void testFindAll_whenUserExists_thenReturnListWithDto() {
    ...
    @SneakyThrows
    @Test
    void testUpdate_whenUserWithoutName_thenReturnBadRequest() {
        Long userId = 1L;
