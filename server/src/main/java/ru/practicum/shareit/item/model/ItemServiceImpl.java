...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto addNewItem(Long ownerId, ItemDto itemDto) {
        Item item = itemRepo.save(itemMapperService.addNewItem(ownerId, itemDto));
    ...
    public List<ItemDto> getItems(Long userId) {
        return itemMapperService.getItems(itemRepo.findAllByOwnerIdOrderById(userId));
    }

    @Override
    public ItemDto updateItem(Long ownerId, Long itemId, ItemDto itemDtoWithUpdate) {
        Item itemUpdated = itemRepo.save(itemMapperService.prepareItemToUpdate(ownerId, itemId, itemDtoWithUpdate));
    ...
    public void deleteItem(Long ownerId, Long itemId) {
        ...
        itemRepo.delete(ItemMapper.makeItem(getItem(itemId, ownerId), owner).get());
    }
