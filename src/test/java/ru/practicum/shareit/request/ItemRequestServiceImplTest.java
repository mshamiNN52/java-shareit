...
class ItemRequestServiceImplTest {
    ...
    @Test
    void testGetItemRequest_whenEntityFound_thenReturnDto() {
    ...
    @Test
    void testAddNewItemRequest_whenRequestIsCorrect_thenReturnDto() {
    ...
    @Test
    void testAddNewItemRequest_withWrongUser_thenUserNotFoundExceptionThrown() {
    ...
    @Test
    void testAddNewItemRequest_withoutDescription_thenValidationExceptionExceptionThrown() {
    ...
    @Test
    void testGetItemRequests_whenRequestIsFound_thenReturnListWithDto() {
        when(itemRequestMapperService.requesterValidate(1L)).thenReturn(true);
    ...
    @Test
    void testGetItemRequests_whenRequestIsNotFound_thenThrowItemRequestNotFoundException() {
        when(itemRequestMapperService.requesterValidate(1L)).thenReturn(true);
    ...
    @Test
    void testGetItemRequests_whenUserHasNoRequests_thenReturnEmptyList() {
        when(itemRequestMapperService.requesterValidate(1L)).thenReturn(true);
