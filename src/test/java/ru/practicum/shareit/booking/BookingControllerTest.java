...
class BookingControllerTest {
    ...
    @Test
    @SneakyThrows
    void testGetBooking_whenCorrect_thenReturn200() {
    ...
    @Test
    @SneakyThrows
    void testGetBookingsOwner_whenCorrect_thenReturn200() {
    ...
    @Test
    @SneakyThrows
    void testGetBookingsOwner_whenStateNotValid_thenReturn400() {
        mockMvc.perform(get("/bookings/owner")
                        .header(SHARER_USER_ID, 1L)
                        .param("state", "heh"))
    ...
    @Test
    @SneakyThrows
    void testGetBookings_whenCorrect_thenReturn200() {
    ...
    @Test
    @SneakyThrows
    void testGetBookings_whenStateNotValid_thenReturn400() {
        mockMvc.perform(get("/bookings")
                        .header(SHARER_USER_ID, 1L)
                        .param("state", "heh"))
                .andExpect(status().isBadRequest());
    ...
    @Test
    @SneakyThrows
    void testGetBookings_whenFromNotValid_thenReturn400() {
        mockMvc.perform(get("/bookings")
                        .header(SHARER_USER_ID, 1L)
                        .param("from", "-10")
    ...
    @Test
    @SneakyThrows
    void testGetBookings_whenSizeNotValid_thenReturn400() {
        mockMvc.perform(get("/bookings")
                        .header(SHARER_USER_ID, 1L)
                        .param("size", "0")
                        .contentType("application/json")
    ...
    @Test
    @SneakyThrows
    void testAdd_whenInputCorrect_thenReturn200WithDto() {
    ...
    @Test
    @SneakyThrows
    void testAdd_whenInputWithoutEnd_thenReturn400() {
    ...
    @Test
    @SneakyThrows
    void testAdd_whenInputWithoutStart_thenReturn400() {
    ...
    @Test
    @SneakyThrows
    void testAdd_whenInputWithoutItemId_thenReturn400() {
    ...
    @Test
    @SneakyThrows
    void testApprove_whenInputCorrectAndStatusApprove_thenReturn200WithDto() {
    ...
    @Test
    @SneakyThrows
    void testApprove_whenInputCorrectAndStatusRejected_thenReturn200WithDto() {
