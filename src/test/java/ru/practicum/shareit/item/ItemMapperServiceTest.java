...
class ItemMapperServiceTest {
    ...
    @Test
    void testPrepareItemToUpdate_whenRequestIsCorrect_thenReturnItem() {
    ...
    @Test
    void testAddNewItem_whenNameNotValid_thenThrowIncorrectItemDtoException() {
    ...
    @Test
    void testAddNewItem_whenNotAvailable_thenThrowIncorrectItemDtoException() {
    ...
    @Test
    void testAddNewItem_whenNotDescription_thenThrowIncorrectItemDtoException() {
        ItemDto itemDtoNotValid = ItemDto.builder()
                .available(true)
                .name(item.getName())
                .description("")
    ...
    @Test
    void testAddNewItem_whenRequestIdNull_thenReturnEntityWithoutRequest() {
    ...
    @Test
    void testAddNewItem_whenRequestCorrect_thenReturnEntity() {
        UserDto userDto = UserMapper.makeDto(userOwner).orElseThrow();
        when(userService.getUser(ownerId)).thenReturn(userDto);
    ...
    @Test
    void testPrepareItemToUpdate_whenIdUserNotValid_thenThrowIncorrectIdException() {
    ...
    @Test
    void testPrepareItemToUpdate_whenIdItemNotValid_thenThrowIncorrectIdException() {
        IncorrectIdException ex = assertThrows(IncorrectIdException.class,
    ...
    @Test
    void testGetItemDto_whenCorrect_thenReturnDto() {
    ...
    @Test
    void testGetItems_whenListItemCorrect_thenReturnListDto() {
    ...
    @Test
    void testGetItemDtoForOwner_whenIncomeRequestCorrect_thenReturnItem() {
        BookingForItemDto lastBooking = new BookingForItemDto();
        BookingForItemDto nextBooking = new BookingForItemDto();
    ...
    @Test
    void testGetItemDtoForUser_whenIncomeRequestCorrect_thenReturnItem() {
        BookingForItemDto lastBooking = new BookingForItemDto();
        BookingForItemDto nextBooking = new BookingForItemDto();
        ItemDto expectedItemDto = new ItemDto(1L, "test item", "item description", true,
                1L, null, new ArrayList<>(), lastBooking, nextBooking);
    ...
    @Test
    void testGetItems_whenNextBookingNotFound_thenReturnListWithItemWithNullLastBooking() {
    ...
    @Test
    void testPrepareCommentToSave_whenCorrectIncome_thenReturnComment() {
        Long authorId = 3L;
    ...
    @Test
    void testPrepareCommentToSave_whenBookingListEmpty_thenThrowValidationException() {
        Long authorId = 3L;
        User author = User.builder()
                .id(authorId)
                .name("Author Name")
