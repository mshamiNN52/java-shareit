...
class ItemControllerMockitoTest {
    ...
    @Test
    @SneakyThrows
    void testAddComment_whenCorrect_thenStatus200AndReturnCommentDto() {
    ...
    @Test
    @SneakyThrows
    void testAddComment_whenInputNotValid_thenStatus400() {
    ...
    @Test
    @SneakyThrows
    void testGetItems_whenCorrect_thenStatus200() {
    ...
    @Test
    @SneakyThrows
    void testSearchItems_whenCorrect_thenStatus200() {
    ...
    @Test
    @SneakyThrows
    void testDeleteItem_whenCorrect_thenStatus200() {
